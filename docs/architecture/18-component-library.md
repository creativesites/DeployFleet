...
| **Command Panel** | The generic "type to search/act" input-plus-results-list primitive | Shared base for both the Command Palette (global) and any scoped-search use (e.g., searching within a Mega Menu) |
